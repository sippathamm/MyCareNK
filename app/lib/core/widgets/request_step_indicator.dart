...
/// Shared 3-step indicator (form → confirm → success) used across the condom
/// request flow. [step] is the zero-based index of the current step.
Widget buildRequestStepIndicator(BuildContext context, int step) {
