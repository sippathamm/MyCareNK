...
class AppointmentStatusVisuals {
  final Color color;
  final Color lightBg;
  final IconData icon;

  const AppointmentStatusVisuals({
    required this.color,
    required this.lightBg,
    required this.icon,
  });

  factory AppointmentStatusVisuals.of(String status) {
    switch (status) {
      case 'pending':
        return const AppointmentStatusVisuals(
      ...
      default: // cancelled_by_user / cancelled_by_staff
        return AppointmentStatusVisuals(
