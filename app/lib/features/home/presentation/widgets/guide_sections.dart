...
Widget _section5(GlobalKey key) {
  return GuideSection(
    ...
    children: [
      ...
      _p('หากต้องการปรึกษาเพิ่มเติม กดปุ่ม "นัดรับคำปรึกษา" ที่แสดงบนหน้าผลประเมิน ระบบจะพาไปยังหน้านัดรับคำปรึกษาโดยตรง'),
    ],
  );
}
...
Widget _section6(GlobalKey key) {
  return GuideSection(
    ...
    children: [
      ...
      _div(),
      _h('6.2 การติดตามสถานะการนัด'),
      _p('หลังส่งคำนัดแล้ว เจ้าหน้าที่จะดำเนินการตามขั้นตอนดังนี้'),
      GuideWidgetTable(
        headers: const ['สถานะ', 'คำอธิบาย'],
        columnFlex: const [2, 3],
        rows: [
          [_statusCell(GuideStatusType.pending, 'รอยืนยัน'), _textCell('ส่งคำนัดแล้ว รอเจ้าหน้าที่ยืนยัน')],
      ...
      const GuideInfoBox(
        type: GuideInfoBoxType.note,
        text: 'แอปจะแจ้งเตือนในแท็บ "แจ้งเตือน" ทุกครั้งที่สถานะการนัดเปลี่ยน',
      ),
      _div(),
      _h('6.3 ประวัติการนัด'),
      _p('ดูการนัดทั้งหมดได้ที่ "บริการ → นัดรับคำปรึกษา → ประวัติการนัด"'),
      ...
      GuideWidgetTable(
        ...
        rows: [
          [
            ...
            _textCell('ระบบได้รับการนัดรับคำปรึกษาของคุณเรียบร้อย รอเจ้าหน้าที่ยืนยัน'),
          ],
          [
            _statusCell(GuideStatusType.ready, 'ยืนยันแล้ว'),
            _textCell('การนัดรับคำปรึกษาของคุณได้รับการยืนยันแล้ว กรุณามาที่ [สถานบริการ] ภายในวันที่ [วันที่ เวลา น.]'),
          ],
          [
            _statusCell(GuideStatusType.completed, 'เสร็จสิ้น'),
            _textCell('การนัดรับคำปรึกษาของคุณเสร็จสิ้นแล้ว'),
          ],
          [
            _statusCell(GuideStatusType.cancelled, 'ยกเลิก (คุณ)'),
            _textCell('คุณได้ยกเลิกการนัดรับคำปรึกษานี้แล้ว'),
          ],
          [
            _statusCell(GuideStatusType.cancelled, 'ยกเลิก (เจ้าหน้าที่)'),
            _textCell('การนัดรับคำปรึกษานี้ถูกยกเลิกโดยเจ้าหน้าที่ คุณสามารถดูรายละเอียดได้ที่ บริการ > นัดรับคำปรึกษา > ประวัติการนัด > รายละเอียด > เหตุผล'),
          ],
        ],
      ),
    ],
